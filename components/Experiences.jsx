...
export default function Experiences({ experiences }) {
    ...
    return (
        <motion.div
            ...
            <div className='w-full flex space-x-5 overflow-x-scroll overflow-y-hidden p-2 md:p-10 pb-28 md:snap-x snap-mandatory  scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80 scrollbar-thin'>
                {/* <ExperienceCard />
                <ExperienceCard />
                <ExperienceCard />
                <ExperienceCard /> */}
